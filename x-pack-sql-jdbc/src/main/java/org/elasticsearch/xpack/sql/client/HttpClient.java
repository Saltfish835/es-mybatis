...
public class HttpClient {
    ...
    private <Request extends AbstractSqlRequest, Response> Response post(String path, Request request,
        ...
        ResponseOrException<Tuple<XContentType, byte[]>> post = JreHttpUrlConnection.http(path, query, cfg, con ->
                con.request(
        ...
        Tuple<XContentType, byte[]> response =
            AccessController.doPrivileged((PrivilegedAction<ResponseOrException<Tuple<XContentType, byte[]>>>) () ->post
